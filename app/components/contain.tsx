...
export default function Contain({ data }: ContainProps) {
  ...
  return (
    <>
      <div className="space-card" onClick={handleCardClick} onKeyDown={handleKeyDown} role="button" tabIndex={0}>
        ...
        <div className="card-content">
          ...
          <div className="card-footer">
             ...
             <div className="card-action">
                ...
                <svg className="mt-[10px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button className="download-btn" onClick={() => window.open(`/api/download/${data.name}`, '_blank')}>
